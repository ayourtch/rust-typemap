...
pub trait CloneAny: Any {
    ...
    #[doc(hidden)]
    fn clone_any_send(&self) -> Box<dyn CloneAny + Send> where Self: Send;
    #[doc(hidden)]
    fn clone_any_sync(&self) -> Box<dyn CloneAny + Sync> where Self: Sync;
    #[doc(hidden)]
    fn clone_any_send_sync(&self) -> Box<dyn CloneAny + Send + Sync> where Self: Send + Sync;
}
